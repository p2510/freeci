                                        ...
                                        <div class="job-listing-details">
                                            ...
                                            <div class="job-listing-description">
                                                <h3 class="job-listing-title"><a
                                                        href="{{ route('mission.show', $data->title) }}">{{ $data->title }}
                                                        @if ($data->accepted == 1)
                                                            (Contacter le recruteur : {{ $data->phone }})
                                                        @endif
                                                    </a>
                                                </h3>
                                            </div>
                                    ...
                                    <ul class="dashboard-task-info">
                                        ...
                                        <li><strong>
                                                ...
                                                @else
                                                    Pas de réponse
                                                @endif
                                            </strong><span>État</span></li>
                                    </ul>

                                    <!-- Buttons -->
                                    <div class="buttons-to-right always-visible">

                                        <form action="{{ route('applicant.mission.delete', $data->id) }}" method="post">
                                            @csrf
                                            @method('delete')
                                            ...
                                            <button type="submit" class=" button red ripple-effect ico" title="Supprimer"
