        ...
        <div class="dashboard-content-container" data-simplebar>
            <div class="dashboard-content-inner">
                ...
                <div class="row">
                    ...
                    <!-- Dashboard Box -->
                    <form method="post" action="{{ route('profile.update') }}" class="col-xl-12"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <div class="avatar-wrapper" data-tippy-placement="bottom"
                                            ...
                                            <input class="file-upload" name="profil_photo" type="file"
                                                accept="image/*" />
                                                ...
                                                <div class="submit-field">
                                                    <div class="bidding-widget">
                                                        ...
                                                        <input class="bidding-slider" type="text" name="tjm" required
                                                            ...
                                                            data-slider-handle="custom" data-slider-currency="F"
                                            ...
                                            <div class="col-xl-4">
                                                <div class="submit-field">
                                                    ...
                                                    <div class="attachments-container margin-top-0 margin-bottom-0">
                                                        @if (!is_null($freelancer_information->cv))
                                                    ...
                                                    @else
                                                        <div class="uploadButton margin-top-0">
                                                            ...
                                                            <label class="uploadButton-button ripple-effect"
                                                                for="upload">Ajouter fichier pdf</label>
                                                            <span class="uploadButton-file-name">Taille maximum : 1
                                                                MB</span>
                                                        </div>
                                                    @endif
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="submit-field">
                                                    ...
                                                    <select name="domain" class="selectpicker with-border"
                                                        data-size="10" title="Choisir un domaine"
